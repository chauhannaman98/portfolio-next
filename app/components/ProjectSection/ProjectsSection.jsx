...
const projectsData = [
  {
    id: 1,
    title: "Munch Lane",
    description: "An eCommerce store for ordering food items with complete payment checkout through RazorPay and PayPal. Admin panel to handle orders, products, and users.",
    image: "/images/projects/munch-lane.png",
    tag: ["All", "Web"],
    gitUrl: "https://github.com/chauhannaman98/munch-lane",
    previewUrl: "https://munchlane.techmirtz.com/",
  },
  {
    id: 2,
    title: "Ramcharitmanas API",
    description: "Build on FastAPI, an API for all chapter and verses of Ramcharitmanas",
